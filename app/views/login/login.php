...
<body class="text-white flex items-center justify-center min-h-screen">
  <div class="glass p-8 rounded-2xl shadow-2xl w-full max-w-md mx-4">
    ...
    <form method="post" id="loginForm" action='../homeController/loginAction' type="submit">
      <div class="mb-6">
      ...
      <button type="submit" class="w-full btn-primary text-white py-3 rounded-lg font-semibold" name='submit'>Login</button>
    </form>
