...
?>
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div class="bg-dark-light p-6 rounded-xl">
                ...
                <button id="openAddBalanceModal" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded-lg">Add Balance</button>
            </div>
    ...
    <div id="addBalanceModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <form method="post" action="<?php echo URLROOT . 'walletController/depositWallet'; ?>" id="addBalanceForm">
                <div class="mb-4">
                    <label for="addAmount" class="block text-sm font-medium text-gray-700">Amount</label>
                    <input type="number" id="addAmount" name="addAmount" step="0.01" min="0" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 text-gray-600 focus:border-blue-500 sm:text-sm">
                </div>
                <div class="flex justify-end">
                    <button type="button" id="closeAddBalanceModal" class="mr-4 px-4 py-2 bg-gray-500 text-white rounded-lg">Cancel</button>
    ...
    <script>
        // Open modal
        document.getElementById('openAddBalanceModal').addEventListener('click', function() {
            document.getElementById('addBalanceModal').classList.remove('hidden');
        });

        // Close modal
        document.getElementById('closeAddBalanceModal').addEventListener('click', function() {
